...
export default class ProfileDetails extends Component{
    ...
    render(){
        return(
            <div style={{width:"100%",height:"100%",backgroundColor:"lavenderblush"}}>
                <Header/>
                <div style={{width:"100%", height:"300px"}}>
                    ...
                    <Typography style={{position: "absolute",display: "flex",marginLeft: "120px",top: "400px",fontWeight: 700,fontSize: "30px",alignItems: "flex-end",color:"blue"}}>hello, {this.state.userData.name}</Typography>
                </div>
                <div>
                ...
                <div style={{backgroundColor:"white",width:"70%",display:"flex",flexDirection:"row",margin:"auto",boxShadow: "rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset"}}>
                    <div style={{width:"50%",height:"300px",color:"black",gap:"10px",padding:"30px",display:"flex",flexDirection:"column",marginLeft:"20px",marginBottom:"20px"}}>
